...
`GET /v1/firmantes/rol-activo?documento_identidad=10000000000`
...
Si corre en Docker y consume servicios del host, usar `${HOST_SERVICES_DOMAIN}` en las URLs.
...
```json
{
  ...
  "documento_identidad_firmante": 10000000000,
  "metadatos": {
...
```json
{
  ...
  "firmante": {
    ...
    "documento_identidad": 10000000000
  },
  "s3": {
